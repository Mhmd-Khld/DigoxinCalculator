...
object CalculationService {
    ...
    fun calculateDigoxinDose(params: CalculationParams): DoseResult? {
        ...
        if (params.route == Route.IV) {
            ...
            if (params.interceptA != null && params.interceptA > 0 && params.tHalfA != null && params.tHalfA > 0 && params.tHalfB != null && params.tHalfB > 0) {
        ...
        val displayKa = if (params.tHalfA != null && params.tHalfA > 0) 0.693 / params.tHalfA else 0.0
        val displayKe = if (params.tHalfB != null && params.tHalfB > 0) 0.693 / params.tHalfB else 0.0
        if (params.route == Route.ORAL && params.tHalfB != null && params.tHalfB > 0) {
            finalK = displayKe
        }
